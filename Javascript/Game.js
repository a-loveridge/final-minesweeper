...
document.addEventListener("DOMContentLoaded", () => {
    document.getElementById("easy").addEventListener("click", () => startGame(DIFFICULTIES.easy));
    document.getElementById("medium").addEventListener("click", () => startGame(DIFFICULTIES.medium));
    document.getElementById("hard").addEventListener("click", () => startGame(DIFFICULTIES.hard));
...
function onLeftClick(row, col) {
    ...
    if (cell.isMine) {
        ...
        UI.renderBoard(currentBoard, onLeftClick, onRightClick);
        UI.renderHUD(currentDifficulty.mines - flaggedCount, `A wild ${cell.pokemon.name} appeared! You lose!`);
        return;
    }
